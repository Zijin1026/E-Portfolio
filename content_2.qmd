...
Several remote sensing applications introduced earlier—such as surface temperature, vegetationconditions, air quality–related indicators are integrated into our map as part of the decision-makingfactors.​ These datasets are combined with other environmental and urban indicators, normalized to acomparable scale, and then used to calculate a livability score.
